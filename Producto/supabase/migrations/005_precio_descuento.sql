...
-- ─── Recrear vista v_valor_inventario con precio_descuento ───────────────────
-- DROP primero porque se agregan columnas nuevas (precio_descuento, precio_vigente)
...
BEGIN
  ...
  -- Usar precio explícito si se pasa, sino tomar precio vigente del producto
