...
CREATE TABLE IF NOT EXISTS movimientos (
  ...
  motivo        VARCHAR(20) CHECK (motivo IN ('COMPRA','VENTA','MERMA','AJUSTE','DEVOLUCION')),
  observacion   TEXT,
...
-- fn_registrar_entrada base (sin precio — se actualiza en 007)
...
-- fn_registrar_salida base (se sobreescribe en 003, 005 y 008)
